...
import { mockPatient, mockConsultations, mockTriages, mockExams, mockVaccines } from "@/lib/mock-data"
...
export default function EHRPage() {
  ...
  const renderContent = () => {
    switch (activeSection) {
      case "patient":
        return <PatientCard patient={pacient} triages={triagens} consultations={consultas} />
      case "consultations":
        return <ConsultationsList patient={pacient} consultations={consultas} reloadConsultations={carregarConsultas}/>
      case "triage":
        return <TriageCard patient={pacient} triages={triagens} reloadTriages={carregarTriagens}/>
      case "exams":
        return <ExamsList patient={pacient} exams={exames} reloadExams={carregarExames}/>
      case "vaccines":
        return <VaccinesList patient={pacient} vaccines={vacinas} reloadVaccines={carregarVacinas}/>
      default:
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      <EHRSidebar activeSection={activeSection} onSectionChange={setActiveSection} />
